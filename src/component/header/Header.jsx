...
function Header() {
  ...
  return (
    <div className="main-header">
      ...
      <nav className="d-flex flex-row justify-content-between align-items-center px-5 pt-4 navMenu">
        <span className="name-nav">KHALED</span>
        <div className="desk-nav d-flex flex-row">
          ...
          <Link to="quotes" spy={true} smooth={true} offset={50} duration={500}>
            Quotes
          </Link>
          <Link
            to="Contact-me"
        ...
        <div className=" home-section  ">
          <div className="text-section d-flex flex-column align-items-center">
            ...
            <p data-aos="fade-in" className=" text-description text-center">
              I buid Fullstack application front to back <br /> <b>Reactjs</b>{" "}
